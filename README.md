...
| `terms/index.html` | `/terms/` | Terms of Service (published legal page) |
| `privacy/index.html` | `/privacy/` | Privacy Policy (published legal page) |
...
- Legal: the Terms and Privacy pages are the site's published legal pages, built
  on the parameters for MAABLAB LLC (California; Los Angeles County venue; no
  arbitration; liability cap the greater of 12-month spend or USD 100; 13+/16+
  age policy). Open items still pending attorney review are tracked in the Bough
  monorepo (embedded business decisions to ratify and a few factual items:
  PostHog region, Nominatim hosting, Gemini no-training terms, full mailing
  address).
